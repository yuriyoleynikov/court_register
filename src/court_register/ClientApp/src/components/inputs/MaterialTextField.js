...
exports.default = mobx_react_1.observer(function (_a) {
    ...
    return (React.createElement("div", null,
        React.createElement(TextField_1.default, __assign({ id: "standard-basic", label: "Standard" }, field.bind({ type: type, placeholder: placeholder, validatingText: validatingText }))),
